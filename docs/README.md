...
- `ROADMAP.md` — Phase-level roadmap (Phase 36 complete)
- `TASK_MODEL.md` — Plan, task, kanban, diff, and execution log data models
- `VIBE_KANBAN_INTEGRATION.md` — Vibe Kanban bridge architecture and Phase 36 integration
...
Supporting Docs (Phase 36 Complete):

- `DESIGN_SYSTEM.md` — UI design rules (Dark+Pink theme)
- `LOCAL_RUNNER_ARCHITECTURE.md` — Local terminal/IDE automation architecture
- `DEPLOYMENT_CHECKLIST.md` — **Updated Phase 36**: production deployment guide (Vercel, Docker, Node.js)
